CREATE TABLE IF NOT EXISTS `wordpress`.`wpf0_wpforms_payments`(
    ...
    KEY `type` (`type`(10) ),
    KEY `transaction_id` (`transaction_id`(42) ),
    KEY `customer_id` (`customer_id`(42) ),
    KEY `subscription_id` (`subscription_id`(42) ),
    KEY `subscription_status` (`subscription_status`(10) ),
    KEY `title` (`title`(85) )
